...
# TODO: DRY with other label providers
...
func _initialize_components(root: Node) -> void:
	...
	for child in root.get_children():
		...
		var component := child as BoundedStatLabelContainer
...
func _setup_component(component: BoundedStatLabelContainer) -> void:
	component.bounded_stats = _get_base_stats()

func _get_base_stats() -> Array[BoundedStat]:
	var provided_stats: Array[BoundedStat]
	provided_stats.assign(character.character_resources.values())
