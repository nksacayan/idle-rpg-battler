...
func _set_character(p_character: BattleCharacter) -> void:
	...
	if character and character.battle_commands_updated.is_connected(_provide_commands):
		character.battle_commands_updated.disconnect(_provide_commands)
	...
	if character:
		character.battle_commands_updated.connect(_provide_commands)
...
func _provide_commands() -> void:
	if character and is_node_ready():
		battle_command_button_container.battle_commands = character.battle_commands
